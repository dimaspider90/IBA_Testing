...
public class MainTest extends BasicTest {
    ...
    public void navigateToLoginPage() {
        MainPage mainPage = new MainPage();
        LoginPage loginPage = mainPage.clickLogin(); // Переход на страницу логина
        Assert.assertTrue(loginPage.isClickNeedHelpLinkDisplayed(), "The login page isn't loaded properly");
    }
}
